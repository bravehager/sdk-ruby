...
async fn make_workflow_service_rpc(mut client: Client, params: RpcParams) -> RpcResult {
    match params.rpc.as_str() {
        ...
        "update_worker_build_id_compatibility" => rpc_call!(client, update_worker_build_id_compatibility, params),
        "get_worker_build_id_compatibility" => rpc_call!(client, get_worker_build_id_compatibility, params),
        "poll_workflow_execution_update" => rpc_call!(client, poll_workflow_execution_update, params),
        "get_worker_task_reachability" => rpc_call!(client, get_worker_task_reachability, params),
